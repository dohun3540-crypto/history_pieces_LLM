"""Second bounded Round 2 pass using the official Korean History Database."""
...
def main() -> int:
    ...
    campaign.source_configs = lambda: tuple(
        item for item in original() if item.source_id == "korean_history_database"
    )
    campaign.BATCH_ID = "round2-high-precision-002"
    campaign.HIGH_CONFIDENCE_TARGET = 158
    campaign.HARD_STORED_CAP = 218
    campaign.GLOBAL_NETWORK_CEILING = 165
