...
DEFAULT_KEYWORDS = ("목포 개항", "목포 해관", "목포 조계", "목포 항만", "목포 철도", "목포 근대")
...
def parser() -> argparse.ArgumentParser:
    ...
    value.add_argument("--extracted-dir", type=Path, required=True)
    ...
    value.add_argument("--max-accepted", type=int, default=30)
    value.add_argument("--max-per-source", type=int, default=15)
